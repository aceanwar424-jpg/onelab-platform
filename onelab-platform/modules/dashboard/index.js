...
async function renderDashboard() {
  ...
  document.getElementById('main-content').innerHTML = `
    <div class="page-header">
      <div>
        <h1>${greeting}, ${user}! 👋</h1>
        <p>Ringkasan performa sales dan operasional OneLab hari ini</p>
      </div>
      <div class="btn-row">
    ...
    <!-- KPI Row 1: Sales -->
    <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(180px,1fr));gap:12px;margin-bottom:16px" id="dash-kpi">
      ${[1,2,3,4,5,6].map(i=>`
        <div class="kpi-card" style="border-left-color:var(--border)">
          <div class="kpi-icon" style="background:var(--lgray)"><div class="spinner" style="width:20px;height:20px;border-width:2px"></div></div>
          <div><div class="kpi-val" style="font-size:16px;color:#ccc">—</div><div class="kpi-label">Loading...</div></div>
        </div>`).join('')}
    </div>

    <!-- Pipeline Bar -->
    <div class="card" style="margin-bottom:14px">
      <div class="card-title" style="margin-bottom:10px">Sales Pipeline</div>
      <div id="dash-pipeline-bar" style="display:flex;gap:3px;height:10px;border-radius:6px;overflow:hidden;margin-bottom:8px"></div>
      <div id="dash-pipeline-legend" style="display:flex;gap:12px;flex-wrap:wrap"></div>
    </div>
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:14px;margin-bottom:14px">
      ...
      <!-- Follow-up Reminder -->
      <div class="card">
        <div class="card-title" style="margin-bottom:10px">⏰ Follow-up Hari Ini</div>
        <div id="dash-followup"><div class="loading-row" style="padding:20px"><div class="spinner"></div></div></div>
      </div>

      <!-- Recent Deals -->
      <div class="card">
        <div class="card-title" style="margin-bottom:10px">🤝 Output Kerjasama Terbaru</div>
        <div id="dash-deals"><div class="loading-row" style="padding:20px"><div class="spinner"></div></div></div>
      </div>
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:14px">
      ...
      <div class="card">
        <div class="card-title" style="margin-bottom:10px">👥 Team Performance (Bulan Ini)</div>
        <div id="dash-team"><div class="loading-row" style="padding:20px"><div class="spinner"></div></div></div>
      </div>

      <div class="card">
        <div class="card-title" style="margin-bottom:10px">📋 Aktivitas Terbaru</div>
