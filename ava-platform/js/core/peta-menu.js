        ...
        },
        {
          ...
          "menu": [
            ...
            },
            {
              ...
              "label": "Hasil Patologi Klinik (Viewer LIS)",
              "status": "ada",
              "ket": "Viewer read-only hasil Patologi Klinik yang sudah dirilis LIS; koreksi dan rilis tetap dilakukan di LIS"
            },
            {
              "id": "his-microbiology",
              "label": "Hasil Mikrobiologi (Viewer LIS)",
              "status": "ada",
              "ket": "Viewer read-only hasil pewarnaan, kultur, identifikasi, dan sensitivitas yang sudah dirilis LIS"
            },
            {
              "id": "his-anatomical-pathology",
              "label": "Hasil Patologi Anatomi (Viewer LIS)",
              "status": "ada",
              "ket": "Viewer read-only hasil histopatologi dan sitologi yang sudah dirilis LIS"
            },
            {
              "id": "his-procedures",
      ...
      "grup": [
        {
          ...
          "menu": [
            {
              "id": "supportive",
              "label": "Dashboard Pemeriksaan Penunjang",
              "status": "ada",
              "ket": "Ringkasan kerja EKG, treadmill, audiometri, dan spirometri dengan interpretasi terstruktur"
            },
            {
              "id": "ekg-treadmill",
              "label": "EKG & Treadmill",
              "status": "ada",
              "ket": "Input dan tinjau pemeriksaan elektrokardiografi serta uji latih jantung"
            },
            {
              "id": "audiometry",
              "label": "Audiometri",
              "status": "ada",
              "ket": "Input ambang pendengaran, PTA, klasifikasi telinga kanan-kiri, dan rekomendasi"
            },
            {
              "id": "spirometry",
              "label": "Spirometri",
              "status": "ada",
              "ket": "Input fungsi paru, pola gangguan, grafik pendukung, dan interpretasi"
            },
            {
              "id": "sm-usg",
